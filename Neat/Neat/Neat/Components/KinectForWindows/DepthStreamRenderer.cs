    ...
    public class DepthStreamRenderer : Object2D
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            */
            ...
            (Game as NeatGame).AssignTexture(new Sprite(backBuffer), "kinectdepth");
            if ((Game as NeatGame).AutoDraw) SharedSpriteBatch.Begin();
        ...
        protected override void LoadContent()
        {
            ...
            this.kinectDepthVisualizer = (Game as NeatGame).LoadEffect(@"Effects\KinectDepthVisualizer");
        }
